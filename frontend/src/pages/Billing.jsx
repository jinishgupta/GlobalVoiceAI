  ...
  return (
    <div className="p-8 min-h-screen bg-blue-50">
      <header className="mb-8">
        ...
        <p className="text-gray-500 mt-1">Manage your plan, payment method, and view your invoices.</p>
      </header>
          ...
          <div className="bg-white p-8 rounded-2xl shadow">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
              <div>
                ...
                <p className="text-4xl font-extrabold text-indigo-600">Creator Plan</p>
                <p className="text-gray-500 mt-1 font-semibold">$29.00 <span className="font-normal">per month</span></p>
              </div>
              <div className="mt-4 md:mt-0">
                <Link to="/pricing" className="bg-gradient-to-r from-indigo-500 to-violet-600 text-white px-6 py-3 rounded-lg font-semibold hover:from-violet-600 hover:to-indigo-500 transition shadow">
                  Change Plan
                </Link>
              </div>
            </div>
            <div className="mt-8">
              <h3 className="text-lg font-bold text-gray-900 mb-2">Monthly Usage</h3>
              ...
              <div className="w-full bg-gray-200 rounded-full h-3 relative overflow-hidden">
                <div className="bg-gradient-to-r from-indigo-500 to-violet-600 h-3 rounded-full" style={{ width: `${usagePercentage}%` }}></div>
              </div>
              <p className="text-sm text-gray-400 mt-2">Your usage will reset on August 1, 2024.</p>
            </div>
          </div>
                  ...
                  {billingHistory.map((item) => (
                    <tr key={item.invoiceId} className="hover:bg-gray-50">
                      ...
                      <td className="py-4 px-6 text-right">
                        <a href="#" className="flex items-center justify-end text-sm text-indigo-600 hover:underline font-semibold">
        ...
        <div className="lg:col-span-1">
          <div className="bg-white p-8 rounded-2xl shadow">
            ...
            <ul className="space-y-4">
                <li className="flex items-center justify-between p-4 bg-white rounded-lg border-2 border-indigo-500">
                    <div className="flex items-center">
                     ...
                     <span className="px-2 py-1 text-xs font-semibold text-indigo-600 bg-indigo-50 rounded-full">Primary</span>
                </li>
             ...
             <button className="mt-6 w-full text-center bg-gradient-to-r from-indigo-500 to-violet-600 text-white font-semibold py-3 rounded-lg flex items-center justify-center hover:from-violet-600 hover:to-indigo-500 transition">
